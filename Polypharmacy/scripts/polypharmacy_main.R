...
S <- 100L ## number of Monte Carlo samples for approximating the expectations in R-VGAL
S_alpha <- 100L ## number of MC samples for approximating Fisher's/Louis' identities in R-VGA
